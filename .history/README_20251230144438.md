...
一个基于 [Hextra Starter Template](https://github.com/imfing/hextra-starter-template) 和 [CloudFlare-AI-Insight-Daily](https://github.com/dayongi/CloudFlare-AI-Insight-Daily) 的全自动化 AI 新闻发布项目。
...
*   **后端驱动**：核心逻辑由 [CloudFlare-AI-Insight-Daily](https://github.com/dayongi/CloudFlare-AI-Insight-Daily) 提供，利用 Cloudflare Workers 和 AI 实现新闻内容的自动化处理。
...
[![部署到 Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/dayongi/Hextra-AI-Insight-Daily)
...
*   提交一个 [Issue](https://github.com/dayongi/Hextra-AI-Insight-Daily/issues)
*   或者创建一个 [Pull Request](https://github.com/dayongi/Hextra-AI-Insight-Daily/pulls)
